...
Usage:
    ...
    init_tables, renewal_task, pending_poller = bootstrap_payments(app, db, limiter)
"""
...
def bootstrap_payments(app, db, limiter):
    """Returns (init_tables_coroutine, renewal_scheduler_coroutine, pending_poller_coroutine)."""
