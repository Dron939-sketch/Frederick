...
AI-профиль:
{profile.get('ai_generated_profile', 'Нет данных')[:1000]}

Проведи анализ по указанной структуре. Пиши коротко, по делу, без воды.
"""
        
        response = await ai_service._call_deepseek(system_prompt, user_prompt, max_tokens=2500, temperature=0.7)
