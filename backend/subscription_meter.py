...
class SubscriptionMeter:
    ...
    def _compose_status(self, used_seconds: int, free_days_used: int,
        ...
        # вместо пейволла — дверь в регистрацию: аккаунт даёт 10 минут
        # вместо 3, и это честная причина оставить почту. Переопределение
        # по-прежнему в единственной точке сборки статуса.
