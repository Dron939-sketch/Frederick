...
PROBLEM_CATEGORIES: Dict[str, Dict[str, Any]] = {
    "SINGLE_PARENT": {
        ...
        "not_this": ["выгорание на работе", "тревога/паника", "депрессия в общем", "проблемы в паре"],
    ...
    "AFTER_BREAKUP": {
        ...
        "not_this": ["абьюзивные текущие отношения", "общая депрессия", "одиночество которое всегда было"],
    ...
    "ANXIETY": {
        ...
        "not_this": ["депрессия (апатия, упадок сил)", "выгорание на работе", "горе после потери"],
    ...
    "DEPRESSION": {
        ...
        "not_this": ["тревога/панические атаки", "выгорание на работе", "горе после расставания"],
    ...
    "RELATIONSHIP_CRISIS": {
        ...
        "not_this": ["одиночество (нет партнёра)", "расставание уже произошло", "проблемы с детьми"],
    ...
    "TEEN_PARENT": {
        ...
        "not_this": ["проблемы с маленьким ребёнком", "развод родителей", "выгорание на работе"],
        "best_send_hours": [21, 22],
    },
    "LONELINESS": {
        "code": "LONELINESS",
        ...
        "not_this": ["расставание (есть бывший)", "проблемы в текущих отношениях", "социальная тревога"],
        "best_send_hours": [21, 22, 23],
    },
    "BURNOUT": {
        "code": "BURNOUT",
        ...
        "not_this": ["общая депрессия без упоминания работы", "экзистенциальный кризис без работы", "одиночество, проблемы в отношениях", "суицидальные мысли без связи с работой", "творческий блок художника", "рефлексия итогов года, философские заметки"],
    ...
    "LOW_SELF_ESTEEM": {
        ...
        "not_this": ["общая депрессия", "проблемы в отношениях", "выгорание на работе"],
    ...
    "TOXIC_RELATIONSHIP": {
        ...
        "not_this": ["завершённое расставание", "одиночество", "общая тревога"],
