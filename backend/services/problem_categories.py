...
PROBLEM_CATEGORIES: Dict[str, Dict[str, Any]] = {
    "SINGLE_PARENT": {
        ...
        "topic_markers": ["ребен", "сын", "дочь", "дет", "мама", "алимент", "развод", "папа не", "одна с", "одна воспит"],
    ...
    "AFTER_BREAKUP": {
        ...
        "topic_markers": ["бывш", "расстал", "развел", "ушёл", "ушла", "не отпускает", "забыть", "прокручи", "после расстава"],
    ...
    "ANXIETY": {
        ...
        "topic_markers": ["тревог", "пани", "сердце", "задых", "трясёт", "дрож", "приступ", "страш", "боюсь", "нервнича", "не могу уснуть"],
    ...
    "DEPRESSION": {
        ...
        "topic_markers": ["апати", "пустот", "нет сил", "ничего не хочу", "не радует", "тоскл", "тяжело", "вставать", "бессмысл", "выть хочется"],
    ...
    "RELATIONSHIP_CRISIS": {
        ...
        "topic_markers": ["муж", "жена", "охлад", "поссорил", "развод", "конфликт", "не слыш", "отдалили", "близость", "партн"],
    ...
    "TEEN_PARENT": {
        ...
        "topic_markers": ["подросток", "сын", "дочь", "школ", "переходн", "трудный возраст", "не разговар", "телефон", "замкн"],
        "best_send_hours": [21, 22],
    },
    "LONELINESS": {
        "code": "LONELINESS",
        ...
        "topic_markers": ["одиноч", "один", "одна", "никому", "обнять", "никто не", "не нужен", "не нужна", "вечером один", "вечером одна"],
        "best_send_hours": [21, 22, 23],
    },
    "BURNOUT": {
        "code": "BURNOUT",
        ...
        "topic_markers": ["работ", "уволиться", "увольн", "коллег", "начальник", "офис", "понедельник", "карьер", "зарплат", "босс", "шеф", "выгор"],
    ...
    "LOW_SELF_ESTEEM": {
        ...
        "topic_markers": ["уверенн", "стесн", "комплекс", "сравниваю", "стыдно", "сказать нет", "недостаточ", "хорош", "критик"],
    ...
    "TOXIC_RELATIONSHIP": {
        ...
        "topic_markers": ["газлайт", "абьюз", "обесцен", "манипул", "контролир", "после ссоры", "виновата", "виноват", "страшно", "уйти"],
