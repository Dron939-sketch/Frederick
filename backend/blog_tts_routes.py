...
_BIBLIO_RE = re.compile(r"\n§ (?:Литератур\w*|Что почитать|Источник\w*)[.:]?\s*\n", re.I)
...
# Верхняя граница выросла с 8 до 20: прогон через тестовых слушателей показал,
# что «посчитайте» и «объясните за минуту» с восемью секундами тишины
# невыполнимы — слушатель едет дальше с недодуманным. Длинные паузы ставит
# только автор в HTML (span.pause); режиссёр по промту ограничен 3/5/8.
PAUSE_MIN, PAUSE_MAX, PAUSE_DEFAULT = 2, 20, 5
