...
_ARTIFACTS_RATIONAL: Dict[str, Dict[str, str]] = {
    ...
    "acute_identity": {
        ...
        "icon_emoji": "📊",
        "section": "верхней части бокового меню",
...
_ARTIFACTS_IRRATIONAL: Dict[str, Dict[str, str]] = {
    ...
    "acute_relationships": {
        ...
        "icon_emoji": "🔮",
        "section": "нижней части бокового меню",
...
_B2C_TAIL_SYSTEM = (
    ...
    "  3) НАВИГАЦИЯ С URL (ОБЯЗАТЕЛЬНА): «Открой " + FREDI_LANDING + " — "
    "     слева в меню, в {SECTION}, кнопка {EMOJI} «{ARTIFACT}»». "
    "     Ссылка " + FREDI_LANDING + " ОБЯЗАТЕЛЬНА — без неё ей некуда "
    "     нажать. ЭМОДЗИ И НАЗВАНИЕ из user-сообщения буквально.\n\n"
