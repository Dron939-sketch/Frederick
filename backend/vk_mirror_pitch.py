...
_ARTIFACTS_RATIONAL: Dict[str, Dict[str, str]] = {
    ...
    "acute_anxiety": {
        ...
        "personal_offer_text": "Я проведу тебя через дыхание 4-7-8 и заземление 5-4-3-2-1 — тревога снизится за один сеанс",
    ...
    "acute_sleep": {
        ...
        "icon_emoji": "🌙",
        "section": "блок «Практики»",
        "personal_offer_text": "Я разберу твои сны по Фрейду и Юнгу и проведу самогипноз для засыпания",
    ...
    "acute_relationships": {
        ...
        "personal_offer_text": "Я разберу с тобой твои эго-состояния по Берну — увидишь игры, которые повторяются",
    ...
    "acute_burnout": {
        ...
        "icon_emoji": "📓",
        "section": "блок «Инструменты»",
        "personal_offer_text": "Я заведу тебе дневник эмоций с AI-рефлексией и проведу разбор автомыслей по Беку",
    ...
    "acute_identity": {
        ...
        "personal_offer_text": "Я подготовлю тебе психологический тест 4×6 за 15 минут — точный портрет личности, 16 типов",
    ...
    "acute_meaning": {
        ...
        "icon_emoji": "📊",
        "section": "верх бокового меню",
        "personal_offer_text": "Я разложу твою структуру личности и доминанту мотивации по 4×6",
    ...
    "acute_habits": {
        ...
        "icon_emoji": "⚓",
        "section": "блок «Практики»",
        "personal_offer_text": "Я закреплю тебе якорь нужного состояния — НЛП-техника за 10 минут",
    ...
    "acute_grief": {
        ...
        "icon_emoji": "📓",
        "section": "блок «Инструменты»",
        "personal_offer_text": "Я заведу тебе дневник эмоций с AI-рефлексией — мягко разберём сложные чувства",
    ...
    "baseline_attention": {
        ...
        "icon_emoji": "📊",
        "section": "верх бокового меню",
        "personal_offer_text": "Я подготовлю тебе психотест 4×6 — увидишь себя глазами психолога, а не через лайки",
    ...
    "baseline_recognition": {
        ...
        "icon_emoji": "🪞",
        "section": "верх бокового меню",
        "personal_offer_text": "Я сравню тебя с твоими друзьями — увидишь, как тебя считывают со стороны",
    ...
    "baseline_approval": {
        ...
        "icon_emoji": "📓",
        "section": "блок «Инструменты»",
        "personal_offer_text": "Я заведу тебе дневник эмоций — место, где не нужны лайки, только честность",
    ...
    "baseline_reflection": {
        ...
        "icon_emoji": "📊",
        "section": "верх бокового меню",
        "personal_offer_text": "Я разложу твою личность по 4×6 — глубже, чем VK-лента",
    ...
    "baseline_identity": {
        ...
        "icon_emoji": "📊",
        "section": "верх бокового меню",
        "personal_offer_text": "Я подготовлю тебе точный портрет личности 4×6 — кто ты на самом деле, без позиционирования",
...
_ARTIFACTS_IRRATIONAL: Dict[str, Dict[str, str]] = {
    ...
    "acute_anxiety": {
        ...
        "icon_emoji": "🌀",
        "section": "блок «Практики»",
        "personal_offer_text": "Я проведу тебя через образ безопасного места — голос ведёт, тревога уходит",
    ...
    "acute_sleep": {
        ...
        "icon_emoji": "🌙",
        "section": "блок «Практики»",
        "personal_offer_text": "Я разберу твой сон через символы и архетипы — что говорит твоё бессознательное",
    ...
    "acute_relationships": {
        ...
        "personal_offer_text": "Я разложу для тебя Таро на отношения — энергии партнёра и точки совместимости",
    ...
    "acute_burnout": {
        ...
        "icon_emoji": "🌀",
        "section": "блок «Практики»",
        "personal_offer_text": "Я проведу тебя через ресурсное место и образ потока — тело отпустит напряжение",
    ...
    "acute_identity": {
        ...
        "icon_emoji": "🔮",
        "section": "низ бокового меню",
        "personal_offer_text": "Я составлю твою натальную карту — кто ты по дате рождения, сильные стороны и теневые роли",
    ...
    "acute_meaning": {
        ...
        "icon_emoji": "🧿",
        "section": "блок «Инструменты»",
        "personal_offer_text": "Я напишу тебе сказку под твой запрос — встреча с собой через образ, без терминов",
    ...
    "acute_habits": {
        ...
        "icon_emoji": "⚓",
        "section": "блок «Практики»",
        "personal_offer_text": "Я закреплю тебе образ-якорь — он удержит в нужном состоянии в момент, когда оно нужно",
    ...
    "acute_grief": {
        ...
        "icon_emoji": "🧿",
        "section": "блок «Инструменты»",
        "personal_offer_text": "Я напишу тебе сказку для катарсиса через метафору — когда нет сил говорить прямо",
    ...
    "baseline_attention": {
        ...
        "icon_emoji": "🔮",
        "section": "низ бокового меню",
        "personal_offer_text": "Я разложу карты на твой день — три картинки расскажут о тебе больше, чем лента",
    ...
    "baseline_recognition": {
        ...
        "icon_emoji": "🔮",
        "section": "низ бокового меню",
        "personal_offer_text": "Я составлю твой астрологический портрет — кто ты по знаку и стихии, и как тебя видит мир",
    ...
    "baseline_approval": {
        ...
        "icon_emoji": "🌙",
        "section": "блок «Практики»",
        "personal_offer_text": "Я разберу твой последний сон — что говорит бессознательное, чего не дают лайки",
    ...
    "baseline_reflection": {
        ...
        "icon_emoji": "🔮",
        "section": "низ бокового меню",
        "personal_offer_text": "Я разложу для тебя Таро + натальную карту — зеркало глубже, чем VK-лента",
    ...
    "baseline_identity": {
        ...
        "icon_emoji": "🔮",
        "section": "низ бокового меню",
        "personal_offer_text": "Я составлю твою натальную карту — точный портрет тебя через дату рождения",
...
_B2C_TAIL_SYSTEM = (
    ...
    "PERSONAL_OFFER_TEXT (готовая личная фраза «Я напишу тебе...», «Я "
    "разложу для тебя...», «Я подготовлю тебе...»). Используй буквально.\n\n"
    "СТРУКТУРА КОНЦОВКИ (3-5 коротких строк, связный текст):\n"
    "  1) ОДНА ФРАЗА-НАБЛЮДЕНИЕ: «Я заметил, что ты ...» / «Меня "
    "зацепило, как ты ...». УЧИТЫВАЙ pain_recency:\n"
    "     • current → «сейчас», «прямо сейчас»\n"
    "     • recent → «недавно»\n"
    "     • historical → «когда-то ты прошла через...», «у тебя был "
    "период...» — НЕ «недавно»!\n"
    "     • baseline → «вижу, что ты часто...», «по постам видно...»\n"
    "  2) ЛИЧНОЕ ПРЕДЛОЖЕНИЕ: возьми PERSONAL_OFFER_TEXT из user-"
    "сообщения и используй БУКВАЛЬНО (можешь поменять только пунктуацию). "
    "Это уже готовая фраза от первого лица — НЕ перефразируй её.\n"
    "  3) УКАЗАТЕЛЬ-СЕМЯ: «Открой " + FREDI_LANDING + " — слева в "
    "меню, в {SECTION}, кнопка {EMOJI} «ARTIFACT»». ЭМОДЗИ И НАЗВАНИЕ "
    "из user-сообщения буквально.\n"
    "  4) КОРОТКОЕ ЗАВЕРШЕНИЕ: одна из вариаций — «Бесплатно — "
    "попробуй», «Если откликнется — зайди», «Если зайдёт — будешь "
    "возвращаться. Нет — ничего не теряешь». БЕЗ упоминаний "
    "регистрации, времени, email, пин-кода.\n\n"
    "ЖЁСТКО:\n"
    "  - PERSONAL_OFFER_TEXT, ARTIFACT, EMOJI — БУКВАЛЬНО.\n"
    "  - НИКОГДА не пиши «без регистрации», «10 минут», «email», "
    "«пин-код» — её это не интересует, она сама разберётся на сайте.\n"
    "  - НЕ предлагай ВТОРОЙ инструмент. Один артефакт-семя.\n"
    "  - НЕ ставь диагнозов («у тебя депрессия»).\n"
    "  - НЕ маркетинг («трансформация», «прорыв», «х10»).\n"
...
async def _llm_tail(category_meta: Dict[str, Any], name: str,
    ...
    if b2c_mode:
        ...
        user_msg = (
            ...
            f"PERSONAL_OFFER_TEXT (произнести от первого лица БУКВАЛЬНО): "
...
def _fallback_tail(category_meta: Dict[str, Any],
    ...
    if b2c_mode:
        artifact = _select_artifact(pain_type, cognitive_style)
        return (
            f"{artifact['personal_offer_text']}. Открой {FREDI_LANDING} — "
            f"слева в боковом меню, в {artifact['section']}, найдёшь "
            f"кнопку {artifact['icon_emoji']} «{artifact['name']}». "
            f"Бесплатно — если откликнется, попробуй."
        )
    return (
