...
DRIP_TEMPLATES = {
    "female": {
        "d1": {
            ...
            "voice_body": (
                "Я Фреди, виртуальный психолог. Меня разработал Андрей "
                "Мейстер — и раз ты у него в друзьях, решил рассказать "
                "о себе одной из первых. Если кратко: помогаю распутать "
                "клубок эмоций, увидеть ситуацию под другим углом или "
                "просто проговорить то, о чём молчишь даже с близкими. "
                "Знаешь, иногда достаточно произнести вслух — и уже "
                "легче. Я без оценок, без памяти и без сплетен. "
                "Поговорили, выдохнула — и как будто не было. Ссылку "
                "сейчас кидать не буду — завтра напишу, пришлю. До связи."
            ),
        },
        "d2": {
            "text": (
    ...
    "male": {
        "d1": {
            ...
            "voice_body": (
                "Я Фреди, виртуальный психолог. Меня разработал Андрей "
                "Мейстер — и раз ты у него в друзьях, решил рассказать "
                "о себе одним из первых. Если кратко: помогаю разложить "
                "ситуацию по полочкам, найти неочевидный выход или "
                "проговорить то, что обычно держишь в себе. Знаешь, "
                "иногда достаточно произнести вслух — и уже легче. Я "
                "без оценок, без памяти и без сплетен. Поговорили, "
                "выдохнул — и как будто не было. Ссылку сейчас кидать "
                "не буду — завтра напишу, пришлю. До связи."
            ),
        },
        "d2": {
            "text": (
