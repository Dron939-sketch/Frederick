    ...
    "female": {
        "d1": {
            ...
            "voice_body": (
                ...
                "Мейстер, и ты у него в друзьях, поэтому считаю своим "
                "долгом уведомить тебя одной из первых. Если кратко: я "
                "помогаю разобраться в чувствах, найти решение, когда "
                "всё запуталось, или просто выговориться о том, о чём "
                "не скажешь близким. Без оценок. Без памяти. Без сплетен. "
                "Поговорили — закрыла — всё. Не буду сейчас грузить и "
                "кидать ссылок. Завтра напишу — скину ссылочку, "
                "посмотришь сама."
            ),
        },
        "d2": {
            "text": (
                ...
                "Без обид, без памяти, без сплетен. Поговорили → "
                "закрыла → всё.\n\n"
    ...
    "male": {
        "d1": {
            ...
            "voice_body": (
                "Я Фреди — виртуальный психолог. Меня разработал Андрей "
                "Мейстер, и ты у него в друзьях, поэтому считаю своим "
                "долгом уведомить тебя одним из первых. Если кратко: я "
                "помогаю разложить ситуацию по полочкам, найти "
                "неочевидный выход или просто выговориться, когда "
                "друзей грузить не хочется. Без оценок. Без памяти. "
                "Без сплетен. Поговорили — закрыл — всё. Не буду сейчас "
                "грузить и кидать ссылок. Завтра напишу — скину "
                "ссылочку, посмотришь сам."
            ),
        },
        "d2": {
            "text": (
