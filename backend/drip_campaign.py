    ...
    "female": {
        "d1": {
            ...
            "voice_body": (
                ...
                "Мейстер — и раз ты у него в друзьях, я решил рассказать "
                "тебе одной из первых. Коротко, помогаю распутать клубок "
                "эмоций, увидеть ситуацию под другим углом или проговорить "
                "то, о чём молчишь даже с близкими. Знаешь, иногда "
                "достаточно произнести вслух — и уже легче. Я без оценок "
                "и без сплетен. Поговорили, выдохнула — и как будто не "
                "было. Ссылку сейчас кидать не буду — завтра пришлю. "
                "До связи."
            ),
        },
        "d2": {
    ...
    "male": {
        "d1": {
            ...
            "voice_body": (
                "Я Фреди, виртуальный психолог. Меня разработал Андрей "
                "Мейстер — и раз ты у него в друзьях, я решил рассказать "
                "тебе одному из первых. Коротко, помогаю разложить "
                ...
                "без оценок и без сплетен. Поговорили, выдохнул — и "
                "как будто не было. Ссылку сейчас кидать не буду — "
                "завтра пришлю. До связи."
            ),
        },
        "d2": {
            "text": (
